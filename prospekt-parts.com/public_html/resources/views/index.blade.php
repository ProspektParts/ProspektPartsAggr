...
@section('content')
    <section id="about" class="bg-hero coral position-relative overflow-hidden">
        <div class="container h-100">
            ...
            <video id="myVideo" controls preload="false" autoplay muted>
              <source src="/img/val.mp4" type="video/mp4">
              <source src="/img/DISK.mp4" type="video/mp4">
              <source src="/img/kolodkiidiski.mp4" type="video/mp4">
              <source src="/img/filtr.mp4" type="video/mp4">
            </video>
            <div class="play"></div>
                    ...
                    <div class="d-flex flex-column gap-3 position-relative z-3 p-3 p-lg-0">
                        <h1 itemprop="description" class="fw-bold lh-1 display-4">
                             {{-- shock-wive --}}
                            <span class="text-primary">Поставляем запчасти</span>,
                            комплектующие <br /> и расходные материалы по России
                            <br />
                            <span class="text-primary">для грузовых автомобилей</span></br>
    ...
    <section id="bestsellers" class="bg-secondary-subtle d-lg-block d-none">
        <div class="container" itemscope itemtype="https://schema.org/ItemList">
                ...
                <div class="col-12 pb-5">
                    ...
                    style="background-image: url(/img/banner.png);background-size: cover;background-position: top right;box-shadow: inset 0px -48px 254px 86px #000000bf">
                        ...
                        <p class="text text-light mb-0 mt-3">
                            ...
                            &#160;Акция продлится до <b>31 декабря 2023 года</b>, размеры толстовок 
            ...
            <div class="block-grid">
             <!-- <div class="row mb-5"> -->
                <div class="div1">
                    <a href="/stock/81cf7449-727a-11ee-0a80-130600173515">
                        <img src="/img/goods/promo/powerhub.jpg" alt="Powerhub" class="w-100 rounded shadow-sm" />
                    </a>
                </div>
                <div class="div2">
                ...
                <div class="div3">
                    <a href="/stock/e3295a56-770c-11ee-0a80-096e0020d4ec">
                        <img src="/img/goods/promo/ayku.png" alt="AYKU" class="w-100 rounded shadow-sm" />
                    </a>
                </div>
                <div class="div4">
                    <a href="/stock/c07653f3-5d3d-11ee-0a80-0418001257ed">
                        <img src="/img/goods/promo/suotepower.jpg" alt="SUOTE" class="w-100 rounded shadow-sm" />
                    </a>
                </div>
                
            <div class="div5">
                    <a href="/stock/ef56740b-77e0-11ee-0a80-0cfa001004ff">
                        <img src="/img/goods/promo/mvs.jpg" alt="MVS" class="w-100 rounded shadow-sm" />
                    </a>
                </div>
                
            <div class="div6">
                <a href="/stock/6f6ad146-794c-11ee-0a80-0290001d2dad">
                       <img src="/img/goods/promo/sunex.png" alt="SUNEX" class="w-100 rounded shadow-sm" />
                    </a>
                </div>
                
            <div class="div7">
                <a href="/stock/e0cb6ca7-7a53-11ee-0a80-02dc001281c2">
                       <img src="/img/goods/promo/dongfa.png" alt="DONGFA" class="w-100 rounded shadow-sm" />
                    </a>
                </div>
                
           <div class="div8">
                <a href="/stock/">
                       <img src="/img/goods/promo/proxman.png" alt="PROXMAN" class="w-100 rounded shadow-sm" />
                    </a>
                </div> 
                
            <div class="div9">
                <a href="/stock/d295833c-8399-11ee-0a80-0fb9000b7477">
                       <img src="/img/goods/promo/powerhubF.png" alt="POWERHUB-FILTER" class="w-100 rounded shadow-sm" />
                    </a>
                </div> 
